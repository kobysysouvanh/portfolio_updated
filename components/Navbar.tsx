...
const Navbar = () => {
  return (
    <motion.div
      className="hidden xl:inline h-20 w-full z-[999] bg-neutral-600 backdrop-blur-sm bg-clip-padding backdrop-filter bg-opacity-10 sticky top-0 border-b border-neutral-800"
