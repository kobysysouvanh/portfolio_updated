...
const Contact = () => {
  return (
    <div className="w-full h-full mx-auto mt-32 overflow-x-hidden">
      <div className="border-t border-l border-neutral-800 bg-neutral-600 bg-opacity-10 backdrop-blur-sm p-3">
        <div className="flex w-full flex-wrap sm:flex-nowrap justify-between max-w-7xl mx-auto text-center items-center">
